...
mir = Object (fst $ buildOctree mirror) Reflection
scn = Scene (Vec3 0.1 0 0) mir [Scene (Vec3 2 0 0) obj []]

main = render eye view up fov xres yres scn lights amb limit "mirror.png"
